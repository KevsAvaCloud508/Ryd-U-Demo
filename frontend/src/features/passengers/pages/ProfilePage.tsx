        ...
        <Card className="h-fit p-7 text-center">
          ...
          <div className="mt-5 flex gap-2.5">
            <Card className="flex-1 p-3">
              <b className="text-lg text-white">{average?.average?.toFixed(1) ?? '—'}</b>
              <div className="text-[11px] text-muted">Rating</div>
            </Card>
            <Card className="flex-1 p-3">
              <b className="text-lg text-white">{average?.count ?? 0}</b>
              <div className="text-[11px] text-muted">Viajes</div>
            </Card>
            <Card className="flex-1 p-3">
              <b className="text-lg text-white">${((average?.count ?? 0) * 50).toFixed(0)}</b>
